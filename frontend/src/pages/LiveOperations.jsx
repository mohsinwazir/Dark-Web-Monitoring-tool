        ...
        <div className="h-full flex flex-col space-y-6">
            <div className="flex justify-between items-end">
                <div>
                    ...
                    <p className="text-zinc-400 text-sm">Real-time crawler telemetry and raw data stream.</p>
                </div>
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 min-h-0">
                {/* Main Terminal Area */}
                <div className="lg:col-span-2 bg-black border border-zinc-800 rounded-xl p-4 flex flex-col font-mono relative overflow-hidden shadow-2xl">
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-emerald-500 to-transparent opacity-50"></div>
                    <div className="flex items-center gap-2 mb-4 text-emerald-500 border-b border-zinc-900 pb-2">
                        <Terminal size={16} />
                ...
                <div className="space-y-6">
                    <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4">
                        <h3 className="text-sm font-semibold text-zinc-300 mb-3">Active Spiders</h3>
                        <div className="space-y-2">
                            <div className="space-y-2">
                                <div className="flex justify-between items-center bg-zinc-800 p-2 rounded text-xs">
                                    <span className="text-zinc-400">Clearnet Spider</span>
                                    <span className="text-emerald-400">READY</span>
                                </div>
                                <div className="flex justify-between items-center bg-zinc-800 p-2 rounded text-xs">
                                    <span className="text-zinc-400">Onion Spider (Tor)</span>
                    ...
                    <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4">
                        <h3 className="text-sm font-semibold text-zinc-300 mb-3">Tor Circuit Status</h3>
                        <div className="text-xs space-y-4">
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded bg-zinc-800 flex items-center justify-center">🌐</div>
                                <div className="h-[2px] flex-1 bg-emerald-500/50"></div>
                                <div className="w-8 h-8 rounded bg-zinc-800 flex items-center justify-center">🛡️</div>
                                <div className="h-[2px] flex-1 bg-emerald-500/50"></div>
                                <div className="w-8 h-8 rounded bg-zinc-800 flex items-center justify-center">🧅</div>
                            </div>
